<div class="bg-black/20 min-h-screen fixed inset-0 flex justify-end z-10 max-h-screen">
    ...
    <div class="flex flex-col w-80 bg-white shadow-l-lg h-full p-3 gap-3 max-h-full overflow-y-scroll dark:bg-dark-primary">
