<x-layouts.edit title="Missing Equipment" cancelLocation="/missing-equipment" wire:click="update">
    <x-form.select label="Equipment" :options="$equipments" name="form.equipment_id" wire:model="form.equipment_id" disabled/>
